...
#lnRR 
dat2$lnRR <- log(dat2$high_protein) - log(dat2$low_protein)

#variance
dat2$var <- (dat2$high_sd)^2/((dat2$n_HP)*(mean(dat2$high_protein)^2)) + (dat2$low_sd)^2/((dat2$n_HP)*(mean(dat2$low_protein)^2))
```
