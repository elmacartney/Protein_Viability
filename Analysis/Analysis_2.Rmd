...
### MA with species phylogeny variance co-variance matrix
```{r}
#creating matrix
...
m1a <- rma.mv(yi = lnRR, V = var, random = list(~1|esID,
                                               ~1|paperID,
                                               ~1|order,
                                               ~1|species),
...
orchard<- orchard_plot(m1a, mod = "Int", xlab = "lnRR", alpha=0.4) +  # Orchard plot 
  geom_errorbarh(aes(xmin = lowerPR, xmax = upperPR), height = 0, show.legend = FALSE, size = 1.1, alpha = 0.5)+ # prediction intervals
  geom_errorbarh(aes(xmin = lowerCL, xmax = upperCL), height = 0.05, show.legend = FALSE, size = 2)+ # confidence intervals
  geom_point(aes(fill = name),  size = 5, shape = 21)+ # mean estimate
  # scale_colour_manual(values = "darkorange")+ # change colours
...
m2a <- rma.mv(yi = lnRR, V = 1, random = list(~1|ï..esID,
                                               ~1|paperID,
                                               ~1|order,
                                               ~1|species),
...
orchard<- orchard_plot(m2a, mod = "Int", xlab = "lnRR", alpha=0.4) +  # Orchard plot 
  geom_errorbarh(aes(xmin = lowerPR, xmax = upperPR), height = 0, show.legend = FALSE, size = 1.1, alpha = 0.5)+ # prediction intervals
  geom_errorbarh(aes(xmin = lowerCL, xmax = upperCL), height = 0.05, show.legend = FALSE, size = 2)+ # confidence intervals
  geom_point(aes(fill = name),  size = 5, shape = 21)+ # mean estimate
  # scale_colour_manual(values = "darkorange")+ # change colours
